...
We chose to keep five components so it explains enough the variances (76.2%) but not more to limit the number of components since it does not make us win a lot of explained variances.

```{r}
pca<-PCA(load, scale.unit = T, ncp = 5, graph = F)
```
